...
<form method="get" action="admin.php" class="mb-stack-md">
    ...
    <div class="flex gap-3">
        ...
        <?php if (!empty($busqueda)): ?>
            <a href="admin.php?accion=listar_productores" class="px-4 py-2.5 rounded-full border border-outline-variant text-muted hover:bg-surface-container-low transition-colors flex items-center gap-1">
